    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-slate-100" dir="rtl">
      ...
      <main className="p-4 max-w-lg mx-auto py-10 space-y-6">
        <div className="text-center space-y-3">
          <div className="w-20 h-20 bg-gradient-to-br from-[#43a047] to-[#2e7d32] rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-green-200">
        ...
        <Card className="border-0 shadow-xl shadow-green-100/50 overflow-hidden">
          <div className="h-1 bg-gradient-to-r from-[#66bb6a] to-[#43a047]" />
          <CardContent className="p-8 text-center space-y-6">
            {showError ? (
              <>
                ...
                <Button
                  onClick={handleRetry}
                  className="w-full bg-[#43a047] hover:bg-[#2e7d32] text-white h-12 text-base font-semibold rounded-xl shadow-md"
                >
                  إعادة المحاولة
                </Button>
              </>
              ...
              <>
                <div className="flex flex-col items-center gap-4">
                  <div className="relative">
                    <div className="w-16 h-16 bg-green-50 rounded-full flex items-center justify-center">
                      <Loader2Icon className="w-8 h-8 text-[#43a047] animate-spin" />
                    </div>
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#43a047] rounded-full flex items-center justify-center">
                ...
                <div className="bg-green-50 rounded-xl p-4 border border-green-100 space-y-2 text-right">
                  <div className="flex items-center gap-2 text-[#2e7d32] text-sm">
        ...
        <div className="bg-gradient-to-br from-[#43a047] to-[#2e7d32] rounded-2xl p-6 text-center text-white space-y-4 shadow-lg shadow-green-200 relative overflow-hidden">
          ...
          <p className="text-sm font-medium text-green-100 relative z-10">لتحميل تطبيق نفاذ</p>
      ...
      <Dialog open={showConfirmDialog} onOpenChange={() => {}}>
        <DialogContent className="max-w-sm mx-auto [&>button]:hidden rounded-2xl border-0 shadow-2xl" dir="rtl">
          ...
          <div className="text-center space-y-5 py-2">
            <div className="mx-auto w-44 h-44 bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-3xl shadow-inner flex items-center justify-center">
              <div className="flex gap-4 justify-center items-center" dir="ltr">
                <div className="text-7xl font-black text-[#2e7d32] font-mono leading-none">
                  {confirmationCode?.[0] || "–"}
                </div>
                <div className="text-7xl font-black text-[#2e7d32] font-mono leading-none">
                  {confirmationCode?.[1] || "–"}
            ...
            <div className="flex items-center justify-center gap-2 text-[#43a047]">
              <div className="relative flex items-center justify-center w-4 h-4">
                <div className="w-3 h-3 bg-[#43a047] rounded-full animate-ping absolute opacity-75" />
      ...
      <Dialog open={showOtpDialog} onOpenChange={() => {}}>
        <DialogContent className="max-w-sm mx-auto [&>button]:hidden rounded-3xl border-0 shadow-2xl p-0 overflow-hidden" dir="rtl">
          <div className="h-1 bg-gradient-to-l from-[#66bb6a] via-[#43a047] to-[#2e7d32]" />

          <div className="px-6 pt-5 pb-6 space-y-5">
            <DialogHeader className="text-center space-y-3">
              <div className="flex justify-center">
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#43a047] to-[#2e7d32] flex items-center justify-center shadow-xl shadow-green-200">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                ...
                <span className="font-bold text-[#2e7d32]">4 أرقام</span>{" "}
                الذي وصلك
              </p>
            </DialogHeader>
                ...
                <input
                  ...
                  className={[
                    ...
                    otpError
                      ...
                      : digit
                      ? "border-[#43a047] bg-green-50 text-[#2e7d32]"
                      : "border-slate-200 bg-slate-50 text-slate-800 focus:border-[#43a047] focus:bg-white",
                  ].join(" ")}
                />
              ))}
            </div>
