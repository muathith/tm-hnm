...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      {/* ── Announcement bar ─────────────────────────── */}
      <div className="bg-[#e8f0fe] border-b border-blue-100 py-2 px-4 text-center">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-xs">
          <a href="#" className="flex items-center gap-1 text-[#1976d2] font-bold hover:underline">
            <ChevronLeft className="h-3 w-3" />
            العروض الترويجية
          </a>
          <span className="text-slate-600 font-medium">منصة تأمين موثوقة ومرخصة رسمياً</span>
          <span className="w-20" />
        </div>
      </div>
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-5xl mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            <UserCircle className="h-6 w-6 text-slate-400 cursor-pointer hover:text-[#1976d2] transition-colors" />
      ...
      {/* ── Stats ribbon ─────────────────────────────── */}
      <div className="bg-[#1976d2] text-white py-3 px-4">
        <div className="max-w-5xl mx-auto flex items-center justify-center gap-8 sm:gap-16">
          {[
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        {/* ── Trust section ─────────────────────────────── */}
        <section className="bg-[#f5f7fa] rounded-2xl p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={title} className="bg-white rounded-xl p-4 border border-slate-100 space-y-2">
                <div className="w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center">
                  <Icon className="h-4.5 w-4.5 text-[#1976d2]" />
                </div>
        ...
        {/* ── Help CTA section ─────────────────────────── */}
        <section className="bg-[#1976d2] rounded-2xl p-6 text-white text-center space-y-4">
          <h2 className="text-lg font-black">هل تحتاج مساعدة؟</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="tel:920000000"
              className="flex items-center justify-center gap-2 bg-white text-[#1976d2] font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-blue-50 transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-white/10 border border-white/30 text-white font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-white/20 transition-colors"
            >
              <Mail className="h-4 w-4" />
              راسلنا عبر البريد
            </a>
          </div>
          <div className="flex items-center justify-center gap-6 pt-2 text-xs text-blue-100">
